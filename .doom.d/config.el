...
(after! mu4e
  ...
  (setq mu4e-contexts
        (list
         ...
         (make-mu4e-context
          ...
          :match-func (lambda (msg)
                        (when msg
                          (string-prefix-p "/gmailIIT" (mu4e-message-field msg :maildir))))
          :vars '((user-mail-address . "24f1000722@ds.study.iitm.ac.in")
                  (user-full-name . "Shrishjay Acharya")
                  (mu4e-sent-folder . "/gmailIIT/[Gmail]/Sent Mail")
                  (mu4e-drafts-folder . "/gmailIIT/[Gmail]/Drafts")
                  (mu4e-trash-folder . "/gmailIIT/[Gmail]/Trash")
                  (mu4e-refile-folder . "/gmailIIT/[Gmail]/All Mail")
                  (smtpmail-smtp-server . "smtp.gmail.com")
  ...
  (global-set-key (kbd "C-c m 2") (lambda () (interactive) (mu4e-context-switch nil "gmailIIT"))))
